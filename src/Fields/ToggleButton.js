          ...
          <div className="flex flex-col">
               ...
               <label className="flex items-center cursor-pointer">
                    <div className="relative">
                         ...
                         <div
                              className={`absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition-transform duration-200 ease-in-out ${isCODAvailable ? 'transform translate-x-full bg-green-500' : ''
                                   }`}
                         ></div>
                    </div>
               </label>
