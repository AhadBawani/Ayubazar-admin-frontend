...
import { deleteCompanyHandler, getAllCompaniesOnlyHandler } from '../../Requests/RequestHandler/CompanyRequestHandler';
...
const DeleteCompanyDialog = () => {
     ...
     const handleDialogConfirmation = () => {
          deleteCompanyHandler(dialog?.data?._id)
               .then((response) => {                    
                    dispatch(DialogAction(null));
     ...
     return (
          <div className="p-4 w-[500px]" ref={wrapperRef}>
               <div className='flex justify-between'>
                    <div>
                         <span className='font-semibold text-xl'>Delete Company</span>
                    </div>
                    <div>
               ...
               <div className='mt-4'>
                    Are you sure you want to delete company and it's products ?
               </div>
